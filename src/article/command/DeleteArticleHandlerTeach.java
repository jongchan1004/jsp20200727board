...
import article.service.DeleteArticleServiceTeach;
import article.service.DeleteRequestTeach;
import article.service.DeleteRequestTeach;
...
public class DeleteArticleHandlerTeach implements CommandHandler {

	private static String FORM_VIEW = "/WEB-INF/view/deleteFormTeach.jsp";
	private DeleteArticleServiceTeach deleteService = new DeleteArticleServiceTeach();
	...
	private String processForm(HttpServletRequest req,
		...
		try {
			...
			DeleteRequestTeach delReq = new DeleteRequestTeach(
